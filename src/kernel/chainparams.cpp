...
public:
    CMainParams() {
        ...
        chainTxData = ChainTxData{
            // Data from RPC: getchaintxstats 4096 6581ba19e502468deb8d7d0e73f6e4e53eea8f7fa429ef2d2bd1e8c490116872
            .nTime    = 1785271701,
            .tx_count = 4062735,
            .dTxRate  = 0.0007540883238613954,
        };
    }
};
...
public:
    CTestNetParams() {
        ...
        const char* testnet_genesis_msg = "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks";
        const CScript testnet_genesis_script = CScript() << "04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f"_hex << OP_CHECKSIG;
        genesis = CreateGenesisBlock(testnet_genesis_msg,
                testnet_genesis_script,
                1296688602,
                414098458,
                0x1d00ffff,
                1,
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        const char* signet_genesis_msg = "The Times 03/Jan/2009 Chancellor on brink of second bailout for banks";
        const CScript signet_genesis_script = CScript() << "04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f"_hex << OP_CHECKSIG;
        genesis = CreateGenesisBlock(signet_genesis_msg,
                signet_genesis_script,
                1598918400,
                52613770,
                0x1e0377ae,
                1,
