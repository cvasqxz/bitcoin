...
RPCHelpMan getnewaddress()
{
    return RPCHelpMan{"getnewaddress",
                ...
                "so payments received with the address will be associated with 'label'.\n",
                {
                    ...
                    {"address_type", RPCArg::Type::STR, RPCArg::DefaultHint{"set by -addresstype"}, "The address type to use. Only \"legacy\" is supported in Chaucha."},
                },
                RPCResult{
...
RPCHelpMan getrawchangeaddress()
{
    return RPCHelpMan{"getrawchangeaddress",
                ...
                {
                    {"address_type", RPCArg::Type::STR, RPCArg::DefaultHint{"set by -changetype"}, "The address type to use. Only \"legacy\" is supported in Chaucha."},
                },
                RPCResult{
